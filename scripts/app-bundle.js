...
define('app',["require", "exports", 'aurelia-dependency-injection', './users/router'], function (require, exports, aurelia_dependency_injection_1, router_1) {
    "use strict";
    var App = (function () {
        function App() {
        ...
        App.prototype.configureRouter = function (config, router) {
            ...
            childRouter.configure(function (config) {
                router_1.UserRouter.configureRouter(config, childRouter);
                return config;
            });
            config.mapUnknownRoutes('not-found');
        };
...
define('text!app.html', ['module'], function(module) { module.exports = "<template>\n  <require from=\"./styles.css\"></require>\n\n  <!-- Start Top Bar -->\n  <nav class=\"top-bar\">\n    <div class=\"top-bar-left\">\n      <ul class=\"menu\">\n        <li class=\"menu-text\">${'shell:SiteName' | t}</li>\n      </ul>\n    </div>\n    <div class=\"top-bar-right\">\n      <ul class=\"menu\">\n        <li repeat.for=\"row of router.navigation\" if.bind=\"!row.settings.childRouter\" class=\"${row.isActive ? 'active' : ''}\"><a href.bind=\"row.href\">${row.title | t}</a></li>\n        <li repeat.for=\"row of router.navigation\" if.bind=\"row.settings.childRouter\" class=\"${row.isActive ? 'active' : ''}\">\n          <a href.bind=\"row.href\">${row.title | t}</a>\n          <ul class=\"nested menu\">\n            <li repeat.for=\"row of row.settings.childRouter.navigation\" class=\"${row.isActive ? 'active' : ''}\"><a href.bind=\"row.href\">${row.title | t}></a></li>\n          </ul>\n        </li>\n      </ul>\n    </div>\n  </nav>\n  <!-- End Top Bar -->\n  <router-view></router-view>\n</template>"; });
...
define('text!users/index.1.html', ['module'], function(module) { module.exports = "<template>\r\n    <select>\r\n        <option></option>\r\n    </select>\r\n</template>"; });
