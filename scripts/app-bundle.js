...
define('cart/index',["require", "exports", '../models/contracts/contract'], function (require, exports, contract_1) {
    "use strict";
    var Cart = (function () {
        function Cart() {
            var _this = this;
            this.contracts = [];
            contract_1.Contract.DataContext.getInstance().allDocs().then(function (results) {
...
define('resources/contractModule',["require", "exports", '../models/contracts/actors/signed', '../models/contracts/actors/free', '../models/contracts/contract'], function (require, exports, signed_1, free_1, contract_1) {
    ...
    var ContractModule = (function () {
        function ContractModule() {
            this.edit = new Map();
            this.view = new Map();
            this.addEdit(free_1.FreeActor, "users/free-actor.html");
            this.addEdit(signed_1.SignedActor, "users/signed-actor.html");
        }
        ...
        ContractModule.prototype.addEdit = function (contract, moduleId) {
            this.edit.set(contract_1.Contract.DataContext.getRegistry(contract).roles.join('.'), moduleId);
        };
        ContractModule.prototype.addView = function (contract, moduleId) {
            this.edit.set(contract_1.Contract.DataContext.getRegistry(contract).roles.join('.'), moduleId);
        };
        ContractModule.prototype.getEdit = function (contract) {
            return this.edit.get(contract.roles.join('.'));
        };
        ContractModule.prototype.getView = function (contract) {
            return this.edit.get(contract.roles.join('.'));
        };
        ContractModule.getEdit = function (contract) {
            return this.instance.getEdit(contract);
        };
        ContractModule.getView = function (contract) {
...
define('resources/index',["require", "exports"], function (require, exports) {
    ...
    function configure(config) {
        config.globalResources(['./attributes/attribute']);
    }
    exports.configure = configure;
});
...
define('users/router',["require", "exports"], function (require, exports) {
    "use strict";
    var UserRouter = (function () {
        function UserRouter() {
        }
        UserRouter.configureRouter = function (config, router) {
...
define('resources/elements/edit-contract',["require", "exports", '../contractModule', 'aurelia-framework'], function (require, exports, contractModule_1, aurelia_framework_1) {
    "use strict";
    var EditContract = (function () {
        function EditContract() {
        }
        Object.defineProperty(EditContract.prototype, "module", {
            get: function () {
                return this.contract && contractModule_1.ContractModule.getEdit(this.contract);
            },
            enumerable: true,
            configurable: true
        });
        __decorate([
            ...
            __metadata('design:type', Object)
        ], EditContract.prototype, "contract", void 0);
        __decorate([
            aurelia_framework_1.computedFrom('contract'), 
            __metadata('design:type', String)
        ], EditContract.prototype, "module", null);
        EditContract = __decorate([
            aurelia_framework_1.containerless(),
            aurelia_framework_1.customElement('edit-contract'),
            aurelia_framework_1.useView('./contract.html'), 
            __metadata('design:paramtypes', [])
        ], EditContract);
        return EditContract;
    }());
...
define('resources/elements/submit-contract',["require", "exports", '../../models/contracts/contract', 'aurelia-framework', 'lodash'], function (require, exports, contract_1, aurelia_framework_1, _) {
    ...
    var SubmitContract = (function () {
        ...
        SubmitContract.prototype.cartContract = function () {
            var _this = this;
            var contracts = this.contracts || [this.contract];
            contract_1.Contract.DataContext.getInstance().bulkDocs(contracts).then(function (results) {
                return _.zip(_this.contracts, results)
...
define('resources/elements/view-contract',["require", "exports", '../contractModule', 'aurelia-framework'], function (require, exports, contractModule_1, aurelia_framework_1) {
    "use strict";
    var ViewContract = (function () {
        ...
        Object.defineProperty(ViewContract.prototype, "module", {
            get: function () {
                return this.contract && contractModule_1.ContractModule.getView(this.contract);
            },
            enumerable: true,
            configurable: true
        });
        ...
        ViewContract = __decorate([
            aurelia_framework_1.containerless(),
            aurelia_framework_1.customElement('view-contract'),
            aurelia_framework_1.useView('./contract.html'), 
            __metadata('design:paramtypes', [])
        ], ViewContract);
        return ViewContract;
...
define('text!cart/index.html', ['module'], function(module) { module.exports = "<template></template>"; });
...
define('text!resources/elements/submit-contract.html', ['module'], function(module) { module.exports = "<template>\r\n    <button attribute=\"disabled.bind:disabled\" class=\"btn btn-outline-primary ${disabled?'disabled':''}\" click.delegate=\"cartContract()\" type=\"button\">${'shell:cart' | t}</button>\r\n    <button attribute=\"disabled.bind:disabled\" class=\"btn btn-outline-warning ${disabled?'disabled':''}\" click.delegate=\"commitContract()\" type=\"button\">${'shell:commit' | t}</button>\r\n</template>"; });
