define('app',["require", "exports", 'aurelia-dependency-injection', 'lodash'], function (require, exports, aurelia_dependency_injection_1, _) {
    "use strict";
    var App = (function () {
        function App() {
            this.router = null;
...
define('users/create',["require", "exports", '../models/contracts/actors/free', '../models/contracts/actors/signed'], function (require, exports, free_1, signed_1) {
    "use strict";
    var Create = (function () {
        function Create() {
            this.ActorsDropDownOptions = Create.ActorOptions();
        }
        Object.defineProperty(Create.prototype, "selectedUserType", {
            get: function () {
        ...
        Create.ActorOptions = function () {
            return [
                { factory: function () { return new free_1.FreeActor(null); }, displayName: "user:unsignedUser", template: "./free-actor.html" },
                { factory: function () { return new signed_1.SignedActor(null); }, displayName: "user:signedUser", template: "./signed-actor.html" }
            ];
        };
        return Create;
    }());
...
define('resources/attributes/bs-attach',["require", "exports", 'bootstrap', 'aurelia-framework', 'jquery', 'lodash'], function (require, exports, bs, aurelia_framework_1, $, _) {
    "use strict";
    var bsAttach = (function () {
        function bsAttach(el) {
            this.options = {};
            this.el = $(el);
        }
        bsAttach.prototype.attached = function () {
            var _this = this;
            this.throttleUpdate = _.debounce(function (func) {
                _this.reflow = true;
                func();
            }, 5000);
            this.attachFunc && this.throttleUpdate(this.attachFunc);
        };
        bsAttach.prototype.propertyChanged = function (name, newValue, oldValue) {
            var _this = this;
            this.options[name] = newValue;
            var func = this.attachFunc = function () {
                var plugin = _this.options['plugin'];
                if (plugin && !_this.el.data('zfPlugin')) {
                    bs[plugin] ? new bs[plugin](_this.el, _this.options) : _this.el.bs();
                }
                if (_this.reflow) {
                    bs.reflow(_this.el, _this.options['plugin']);
                    _this.reflow = false;
                }
                if (!newValue) {
                    _this.el.clear();
        ...
        bsAttach = __decorate([
            aurelia_framework_1.customAttribute('fo-attach'),
...
define('text!users/signed-actor.html', ['module'], function(module) { module.exports = "<template bindable=\"actor\">\r\n    <div class=\"form-group\">\r\n        <label for=\"name\">${'user:name'|t}</label>\r\n        <input class=\"form-control\" type=\"text\" value.bind=\"actor.name\">\r\n    </div>\r\n    <div class=\"form-group\">\r\n        <label for=\"key\">${'user:key'|t}</label>\r\n        <input class=\"form-control\" type=\"text\" value.bind=\"actor.publicKeys\">\r\n    </div>\r\n</template>"; });
